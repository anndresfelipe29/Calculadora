		...
		if Lista.numElem()>0:
			...
			if tipoDeValor==1: #valor entero
				...
				if tipoDeValor==1:
					...
					self.ColaPasoArbolPrefijo(Lista, Arbol.Derecho)	
					#Arbol.Izquierdo=Nodo(None,Arbol)
					#Arbol.Izquierdo.valor=Lista.primero()
					#Lista.sacar()					
				elif tipoDeValor==0:
					print "operador matematico"	
					Arbol.Izquierdo=Nodo(None,Arbol)				
				...
				print " no hay un valor valido"	


		else: print "ya no hay mas por agregar a este bello eucalipto"
